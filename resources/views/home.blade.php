...
socket.on('message', function(data){
    ...
    $('#msg-pan').append('<li class="list-group-item bg-dark text-success text-right">' + data + '</li>');
});

function sendmsg()
{
    var message = document.getElementById('msg').value;
    $('#msg-pan').append('<li class="list-group-item bg-dark text-danger text-left">' + message + '</li>');
